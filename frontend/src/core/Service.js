...
const Service = props => {
    ...
    return (
        <Layout
            ...
            description={service && service.description && service.description.substring(0, 100)}
            className="container"
        >
            <div className="row">
                <div className="col-8">
                    {service && service.description && <Card service={service} showViewServiceButton={false} />}
                </div>
